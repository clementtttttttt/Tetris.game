...
var ASM_CONSTS = {
 ...
 498568: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 498651: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 498720: () => { return window.innerWidth; },  
 498750: () => { return window.innerHeight; }
};
